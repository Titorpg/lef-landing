...
const I18N = {
  en: {
    ...
    faq_a17: "Your progress is assessed continuously during classes. At the end of each cycle there's a Knowledge Validation Exam, which is not punitive: it's designed to reinforce your learning, not to pressure you. In your portal you can see how many of the 15 modules you've completed.",
  ...
  es: {
    ...
    faq_a17: "Tu progreso se evalúa de forma continua durante las clases. Al final de cada ciclo hay un Examen de Validación de Conocimientos, que no es punitivo: está diseñado para reforzar tu aprendizaje, no para presionarte. En tu portal ves cuántos de los 15 módulos llevas completados.",
