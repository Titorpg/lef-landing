...
const I18N = {
  en: {
    ...
    c1_p: "Learning English always has a purpose — that's why LEF offers the C1 level: three modules focused on real goals, for your career, your certification and your life in English.",
    c1_cefr: "Modules 13–15",
    c1_1: "Module 13 (C1.1) — HIRED",
    c1_1d: "Simulate real interviews and land the job you want in English.",
    c1_2: "Module 14 (C1.2) — CERTIFIED",
    c1_2d: "Practice the real format and strategies to pass your international exam.",
    c1_3: "Module 15 (C1.3) — FLUENT",
    c1_3d: "Master the natural, cultural English of English-speaking environments.",
    c1_note: "It's an optional, exclusive level, designed for when you've mastered B2: you can take its three modules in order or start with the one that matches your goal. Message us on WhatsApp and we'll build your plan.",
    ...
    faq_a17: "Your progress is assessed continuously during classes. At the end of each cycle there's a Knowledge Validation Exam, which is not punitive: it's designed to reinforce your learning, not to pressure you. In your portal you can see how many modules you've completed on your path — from the module you started in up to C1.3.",
  ...
  es: {
    ...
    c1_p: "Aprender inglés siempre tiene un objetivo — por eso LEF ofrece el nivel C1: tres módulos enfocados en metas reales, para tu trabajo, tu certificación y tu vida en inglés.",
    c1_cefr: "Módulos 13–15",
    c1_1: "Módulo 13 (C1.1) — HIRED",
    c1_1d: "Simula entrevistas reales y consigue el trabajo que quieres en inglés.",
    c1_2: "Módulo 14 (C1.2) — CERTIFIED",
    c1_2d: "Practica formato y estrategias reales para aprobar tu examen internacional.",
    c1_3: "Módulo 15 (C1.3) — FLUENT",
    c1_3d: "Domina el inglés cultural y natural de los entornos anglófonos.",
    c1_note: "Es un nivel opcional y exclusivo, pensado para cuando ya dominas el B2: puedes tomar sus tres módulos en orden o empezar por el que responda a tu objetivo. Escríbenos por WhatsApp y armamos tu plan.",
    ...
    faq_a17: "Tu progreso se evalúa de forma continua durante las clases. Al final de cada ciclo hay un Examen de Validación de Conocimientos, que no es punitivo: está diseñado para reforzar tu aprendizaje, no para presionarte. En tu portal ves cuántos módulos llevas completados de tu ruta: desde el módulo en que empezaste hasta C1.3.",
