...
const I18N = {
  en: {
    ...
    faq_a4: "You can pay by bank transfer or QR (Bre-B key <strong>@lefcenter</strong>, no fees) or through our payment gateway <strong>Wompi</strong>, which accepts credit/debit card, PSE, Nequi, Bancolombia Button, and other methods the platform enables. Both options are available from your student portal.",
    ...
    terms_p8: "Current prices and plans are confirmed directly on WhatsApp at the time of enrollment, and are not published on this site. Payments are made by bank transfer or QR (Bre-B key @lefcenter) or through our payment gateway <strong>Wompi</strong> (credit/debit card, PSE, Nequi, Bancolombia Button, and other methods the platform enables), or through methods coordinated directly with our team.",
  ...
  es: {
    ...
    faq_a4: "Puedes pagar por transferencia o QR bancario (llave Bre-B <strong>@lefcenter</strong>, sin comisión) o a través de nuestra pasarela de pagos <strong>Wompi</strong>, que acepta tarjeta de crédito/débito, PSE, Nequi, Botón Bancolombia y demás medios que la plataforma habilite. Ambas opciones están disponibles desde tu portal de estudiante.",
    ...
    terms_h2_8: "8. Pagos",
    terms_p8: "Los valores y planes vigentes se confirman directamente por WhatsApp al momento de la inscripción, y no se publican en este sitio. Los pagos se realizan por transferencia o QR bancario (llave Bre-B @lefcenter) o a través de nuestra pasarela de pagos <strong>Wompi</strong> (tarjeta de crédito/débito, PSE, Nequi, Botón Bancolombia y demás medios que la plataforma habilite), o mediante los métodos que se coordinen directamente con nuestro equipo.",
